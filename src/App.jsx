  ...
  return (
    <div className="min-h-screen relative overflow-hidden transition-colors duration-300 selection:bg-blue-200 dark:selection:bg-blue-900">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Decorative Glows */}
        <div className="absolute top-0 right-0 -translate-y-12 translate-x-12 blur-3xl opacity-20 dark:opacity-30">
          <div className="aspect-square w-96 rounded-full bg-gradient-to-br from-purple-500 to-indigo-500" />
        </div>
        <div className="absolute bottom-0 left-0 translate-y-12 -translate-x-12 blur-3xl opacity-20 dark:opacity-30">
